...
import { getEnhancedFrontmatter, getFileContents, getMatterData } from "./md";
...
export const fetchAllPostsMeta = async (filter) => {
    ...
    return postFilenames.map(filename => {
        ...
        .map(({ title, slug, author = "", tags = null, image = null, readTime = null, categories = null, description = "", date = null, alt = null }) => ({
            alt,
            author,
            categories,
            date,
