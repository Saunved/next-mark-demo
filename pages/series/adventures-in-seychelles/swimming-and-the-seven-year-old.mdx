...
export const meta = {
    ...
    author: 'Saunved',
    date: '2016-08-21',
    slug: 'series/adventures-in-seychelles/swimming-and-the-seven-year-old',
    image: `${process.env.CLOUDFRONT_URL}/ocean.jpeg`,
    alt: 'Ocean',
    categories: ['funny'],
    series: 'Adventures in Seychelles', // Optional, if series
    seriesId: 'adventures-in-seychelles', // Optional, if series
    order: 2, // Optional, if series
}
...
<CaptionImage alt="Swimming trajectory comic" src={`${process.env.CLOUDFRONT_URL}/trajectory.jpeg`} full />
